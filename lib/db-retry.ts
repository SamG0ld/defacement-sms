...
// A cold database compute (scale-to-zero) refuses or times out the first connection
...
// connection. These are THE common cold-start signatures via the Prisma layer.
...
// default: the first attempt wakes a cold database compute, the retry lands on the
